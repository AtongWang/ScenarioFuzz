...
from sensor_interface import CallBack, OpenDriveMapReader, SpeedometerReader, SensorConfigurationInvalid
...
class AgentWrapper(object):
    ...
    def setup_sensors(self, vehicle, world, clock,debug_mode=False):
        """
        ...
        for sensor_spec in self._agent.sensors():
            ...
            if sensor_spec['type'].startswith('sensor.opendrive_map'):
                ...
                sensor = OpenDriveMapReader(vehicle, world,clock,sensor_spec['reading_frequency'])

            elif sensor_spec['type'].startswith('sensor.speedometer'):
                delta_time = world.get_settings().fixed_delta_seconds
                frame_rate = 1 / delta_time
                sensor = SpeedometerReader(vehicle, world,clock,frame_rate)
    ...
    @staticmethod
    def validate_sensor_configuration(sensors, agent_track):
        """
