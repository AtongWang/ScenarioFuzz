...
def set_args():
    ...
    argparser.add_argument("-o", "--out-dir", default="/workspace2/scenario_fuzz", type=str,
    ...
    while True:
        ...
        while cycle_cnt < conf.max_cycles:
            ...
            while round_cnt < conf.max_mutations: # mutation rounds
                ...
                signal.alarm(alarm_time * 60)  # timeout after 10 mins
                round_cnt += 1
                ...
                ego_dir = sample['Ego_direction']
                if args.direction_set:
                    s_,w_,d_ = sc.get_random_ego_car_start_end_point(ego_dir) 
                else:
                ...
                try:
                    ...
                    print("[-] get_random_other_car_start_end_point timed out. Trying again...")
                    round_cnt -= 1
                    continue
                except Exception as e:
                    print("[-] Error occurred while getting random other car start end point:")
                    traceback.print_exc()
                    ret = -1
                ov_list = sample['Ov'] =sample['Ov'][:len(ov_wp_sp_list)]
                sample['Ov_num'] = len(sample['Ov'])
