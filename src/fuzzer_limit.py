...
def set_args():
    ...
    argparser.add_argument("-o", "--out-dir", default="/workspace2/drive_fuzz", type=str,
    ...
    argparser.add_argument("-s", "--seed-dir", default=None, type=str,
            help="Seed directory")
    argparser.add_argument("-l", "--max_campaign_cnt", default=999, type=int,
            help="Maximum number of error generates")
    argparser.add_argument("-c", "--max-cycles", default=5, type=int,
    ...
    argparser.add_argument("-t", "--target", default="leaderboard:Transfuser", type=str,
    ...
    argparser.add_argument("--town", default=1, type=int,
            help="Test on a specific town (e.g., '--town 3' forces Town03)")
    argparser.add_argument("--timeout", default="40", type=int,
...
def main():
    ...
    conf.max_campaign_cnt = max(len(queue),args.max_campaign_cnt)
    scene_id = 0
    campaign_cnt = 0

    #signal.signal(signal.SIGALRM, handler)

    while campaign_cnt <conf.max_campaign_cnt:
        cycle_cnt = 0
